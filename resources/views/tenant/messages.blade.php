    ...
    <main class="flex-1 overflow-y-auto">
        <div class="p-6 bg-gray-50 dark:bg-gray-900 min-h-screen">
            ...
            <div class="mb-8">
                ...
                <p class="text-lg text-gray-600 dark:text-gray-300">Stay connected with landlords and property managers</p>
            </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6">
                        ...
                        <div class="space-y-3 max-h-96 overflow-y-auto">
                            @forelse($conversations as $conversation)
                                <a href="{{ route('tenant.messages.conversation', $conversation['other_user']->id) }}" class="conversation-link flex items-start space-x-3 p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer {{ $conversation['unread_count'] > 0 ? 'bg-blue-50 dark:bg-blue-900' : '' }}">
                            ...
                            @empty
                                <div class="text-center py-8">
                                    ...
                                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Get started by contacting a landlord about a property.</p>
                                </div>
                            @endforelse
                        </div>
                    </div>
            ...
            <div class="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6">
                    ...
                    <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">Need help with your rental search?</p>
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('Messages page loaded - simplified version');
