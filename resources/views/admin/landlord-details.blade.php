    ...
    <div class="flex-1 min-h-screen bg-gray-50 ml-64">
        <div class="max-w-6xl mx-auto px-6 sm:px-8 lg:px-10 py-10">
            <div class="flex justify-between items-center mb-6">
                <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight">Landlord Details</h1>
                <a href="{{ route('admin.landlords') }}" class="inline-flex items-center px-4 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition duration-300">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="bg-white rounded-3xl shadow-lg border border-gray-200 p-8">
                    ...
                    <div class="space-y-4">
                        <div class="flex justify-between items-center py-2 border-b border-gray-100">
                            ...
                            <span class="text-sm text-gray-900">{{ $landlord->name }}</span>
                        </div>
                        <div class="flex justify-between items-center py-2 border-b border-gray-100">
                            <span class="text-sm font-medium text-gray-600">Email:</span>
                            <span class="text-sm text-gray-900">{{ $landlord->email }}</span>
                        </div>
                        <div class="flex justify-between items-center py-2 border-b border-gray-100">
                            <span class="text-sm font-medium text-gray-600">Phone:</span>
                            <span class="text-sm text-gray-900">{{ $landlord->phone ?? 'N/A' }}</span>
                        </div>
                        <div class="flex justify-between items-center py-2 border-b border-gray-100">
                            <span class="text-sm font-medium text-gray-600">Joined:</span>
                            <span class="text-sm text-gray-900">{{ $landlord->created_at->format('F j, Y') }}</span>
                        </div>
                ...
                <div class="bg-white rounded-3xl shadow-lg border border-gray-200 p-8">
                    <h2 class="text-xl font-semibold text-gray-800 mb-6 flex items-center">
                        ...
                        Properties Overview ({{ $landlord->listings->count() }})
                    </h2>
                    @if($landlord->listings->isEmpty())
