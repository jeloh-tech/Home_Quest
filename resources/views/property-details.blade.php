...
<div class="min-h-screen bg-gray-50 dark:bg-gray-900"
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <!-- Property Header -->
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden mb-8 mt-1">
            <div class="p-8 pt-20">
                <!-- Hero Section -->
                <div class="relative mb-8">
                    <!-- Background Gradient -->
                    <div class="absolute inset-0 bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-gray-800 dark:via-blue-900/20 dark:to-purple-900/20 rounded-xl"></div>

                    <div class="relative p-8">

                        <!-- Property Owner Card -->
                        @include('components.property-owner-card')
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-8">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-8">
                    <h1 class="text-4xl md:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-gray-900 via-blue-800 to-purple-800 dark:from-white dark:via-blue-200 dark:to-purple-200 mb-3 leading-tight">
                        {{ $listing->title }}
                    </h1>
                </div>
            ...
            <div class="space-y-8">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-8">
                    ...
                    <!-- Like Button -->
                    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-8">
                        <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">Like Property</h2>
                        @include('components.like-button', ['listing' => $listing])
                    </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-8">
                    <div class="space-y-4">
                        ...
                        <!-- Back to Listings -->
                        <a href="{{ route('listings') }}" class="w-full bg-gray-600 hover:bg-gray-700 text-white font-semibold py-3 px-4 rounded-lg transition-colors text-center block">
                            Back to Listings
                        </a>
                    </div>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function showSlide(index) {
        ...
        thumbnails.forEach((thumb, i) => {
            if (i === index) {
                thumb.classList.add('border-blue-500', 'shadow-lg', 'scale-105');
                thumb.classList.remove('border-gray-200', 'dark:border-gray-700');
            } else {
                thumb.classList.remove('border-blue-500', 'shadow-lg', 'scale-105');
